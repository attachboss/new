<template>
    <div class="ContainerDiv">
        <div class="ContainerLeft" :style="{ width: isLeftMenuCollapse ? '65px' : '200px', background: currentColor }">
            <div class="LeftTop">
                <div class="LogoTitle">{{ !isLeftMenuCollapse ? "微应急系统" : "" }}</div>
                <div class="FoldIcon" @click="isLeftMenuCollapse = !isLeftMenuCollapse"
            ...
            <el-menu active-text-color="#5F9EA0" :background-color="currentColor" class="el-menu-vertical-demo"
                default-active="1" text-color="#fff"
                :collapse="isLeftMenuCollapse" router>
                <el-menu-item index="1">
                    <el-icon>
                        <monitor />
                    </el-icon>
                    <span>NaviDefault</span>
                </el-menu-item>
                <el-sub-menu index="2">
                    <template #title>
                        <el-icon>
                    ...
                    <el-menu-item-group title="Group One">
                        <el-menu-item index="/Home/Map">item one</el-menu-item>
            ...
            <div class="ContainerTop" :style="{ background: currentColor }">
                <div class="TopNavigation">
                    <el-menu :default-active="activeIndex1" class="el-menu-demo" mode="horizontal"
                        :background-color="currentColor" text-color="#fff" active-text-color="#5F9EA0">
                        ...
                        <el-sub-menu index="5">
                            ...
                            <el-menu-item v-for="(item, index) in GetColor" @click="ChangeColor(index)"
                                :index="'4-' + index" :key="index">{{ item }}</el-menu-item>
                        </el-sub-menu>
                        <el-sub-menu index="6">
                            <template #title>账户管理</template>
                            <el-menu-item index="6-1">个人中心</el-menu-item>
                            <el-menu-item index="6-2">修改密码</el-menu-item>
                            <el-menu-item index="6-3" @click="ExitLogin">退出登录</el-menu-item>
                        </el-sub-menu>
                    </el-menu>
                </div>
            </div>
...
import { UserFilled, MapLocation, Monitor, ShoppingCartFull, Tickets, Operation, CaretLeft, CaretRight } from "@element-plus/icons"
